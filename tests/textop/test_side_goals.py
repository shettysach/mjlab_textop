...
def test_side_goals_spec_fn_adds_two_goals_and_four_walls() -> None:
    ...
    assert tuple(blue_goal.pos) == (0.0, 6.0, 0.005)
    assert tuple(green_goal.pos) == (0.0, -6.0, 0.005)
